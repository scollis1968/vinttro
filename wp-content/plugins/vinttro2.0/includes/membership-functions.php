                    ...
                    ?>
                        <tr class="vehicle-main-row <?php echo $has_issues ? 'has-issues' : 'no-issues'; ?>">
                            ...
                            <td class="driver-cell">
                                <?php if (!empty($car['main_driver'])) : ?>
                                    <?php if (!empty($car['main_driver_phone'])) : ?>
                                        <a href="tel:<?php echo esc_attr(str_replace(' ', '', $car['main_driver_phone'])); ?>">
                        ...
                        <?php if ($has_issues) : ?>
                            <tr class="vehicle-issues-row">
                                <td colspan="5"> <div class="issues-expanded-box">
