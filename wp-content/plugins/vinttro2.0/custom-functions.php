...
function my_plugin_load_scripts() {
    ...
    wp_enqueue_script( 'my-form-preview-script', plugins_url( 'custom-scripts.js', __FILE__ ), array('jquery'), filemtime(plugin_dir_path(__FILE__) . 'custom-scripts.js'), true );
}
